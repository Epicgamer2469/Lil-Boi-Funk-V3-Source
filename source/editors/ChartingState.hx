...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Camera Flash', 'Value 1: Set the camera that will flash\n"camHUD" for arrows & shiz "gameCam" for everything under\n\nValue 2: "Color, Duration".\nColor can be a value like #FFFFFF or WHITE, Duration is just a Float\n\nExample: WHITE,.5'],
		['Change Vignette Alpha', 'Value 1: Vignette to change (1 for 1, 2 for 2)\n\nValue 2: New alpha, Tween duration'],
		['Vignette Lerp', 'Value 1: alphaAdd\nValue 2: defaultAlpha\n\nalphaAdd will add the amount to the alpha\nthen smoothly lerp it back to defaultAlpha\n\nleave both fields blank to disable lerp']
	];
